        ...
        e = function (a) {
            if (!a.getAttribute("data-fluidvids")) {
                ...
                a.parentNode.insertBefore(b, a),
                    a.setAttribute("data-fluidvids", "loaded"),
                    (b.className += "fluidvids"),
                    (b.style.paddingTop = c + "%"),
                    b.appendChild(a);
            }
        },
        f = function () {
            var a = document.createElement("div");
            (a.innerHTML = "<p>x</p><style>" + c + "</style>"),
                b.appendChild(a.childNodes[1]);
        };
    return (
        (a.apply = function () {
            for (
                var b = document.querySelectorAll(a.selector), c = 0;
                c < b.length;
                c++
            ) {
                var f = b[c];
